    ...
    fDetectorConstruction(detectorConstruction)
{
  ...
  // Commands for the Geant4 mother world
  ...
  // Commands for the detector size inside the Geant4 world
  ...
  // Commands for the detector position inside the Geant4 world
  ...
  // Add commands for the cylinder dimensions
  ...
  // Add commands for the cylinder position
