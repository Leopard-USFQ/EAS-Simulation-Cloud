...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  fCrkPar->primaryMomento();// Adjust the initial position of the particle and its momentum.
  ...
  //Particle generator configuration with primary spectrum properties
  ...
  G4cout << "Particle successfully generated." << G4endl;
}
